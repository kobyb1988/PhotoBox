...
namespace ImageMaker.Common.Helpers
{
    ...
    public class WrappingStream : Stream
    {
        ...
        {
            // check parameters
            if (streamBase == null) throw new ArgumentNullException("streamBase");
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing) m_streamBase = null;
        ...
        private void ThrowIfDisposed()
        {
            ...
            if (m_streamBase == null) throw new ObjectDisposedException(GetType().Name);
        }
