...
{
    public class ThreeInOneImageProcessor : PatternImageProcessor
    {
        public ThreeInOneImageProcessor(PatternData pattern, ImageProcessor imageProcessor) : base(pattern, imageProcessor)
        {
        }
